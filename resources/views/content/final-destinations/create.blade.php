...
@section('title', 'Nuevo Destino Final - Coprice')
  ...
  <div class="row justify-content-center">
    <div class="col-md-7">
      <div class="card shadow-none border">
        <div class="card-body">
          <h5 class="card-title mb-4">Nuevo Destino Final</h5>
          ...
          <form action="{{ route('final-destinations.store') }}" method="POST">
            @csrf
            <div class="mb-3">
              <label class="form-label">Nombre <span class="text-danger">*</span></label>
              <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                value="{{ old('name') }}" placeholder="EJ. COPRICE" required autofocus>
            ...
            <div class="mb-3">
              ...
              <input type="text" name="authorization_number" class="form-control @error('authorization_number') is-invalid @enderror"
                value="{{ old('authorization_number') }}" placeholder="EJ. CEL-PRME-061/2009">
