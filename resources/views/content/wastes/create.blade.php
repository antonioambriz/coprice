            ...
            <div class="row g-6">
              ...
              <div class="col-md-4">
                ...
                <select id="physical_state" name="physical_state" class="form-select">
                  ...
                  <option value="Sólido"    {{ old('physical_state') === 'Sólido'    ? 'selected' : '' }}>Sólido</option>
                  <option value="Líquido"   {{ old('physical_state') === 'Líquido'   ? 'selected' : '' }}>Líquido</option>
                  <option value="Semisólido"{{ old('physical_state') === 'Semisólido'? 'selected' : '' }}>Semisólido</option>
                </select>
              </div>
              ...
              <div class="col-md-4">
                ...
                <select id="packaging_type" name="packaging_type" class="form-select">
                  <option value="">— No especificado —</option>
                  <option value="RR"  {{ old('packaging_type') === 'RR'  ? 'selected' : '' }}>RR</option>
                  <option value="RNV" {{ old('packaging_type') === 'RNV' ? 'selected' : '' }}>RNV</option>
                </select>
              </div>
